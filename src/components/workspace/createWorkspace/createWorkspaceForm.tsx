...
export default function CreateWorkSpaceForm() {
  ...
  const [workspaceType, setWorkspaceType] = useState("document");
    ...
    <form className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border dark:border-gray-800 p-6" onSubmit={handleSave}>
      ...
      <div className="mt-6 flex items-center justify-end gap-x-6">
        <button 
          ...
          className="text-sm/6 font-semibold text-gray-900 dark:text-white/90 dark:bg-gray-800 dark:hover:bg-white/[0.03] px-3 py-2 rounded-md"
        >
          Cancel
        </button>
        <button
