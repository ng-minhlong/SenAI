...
const Hero: React.FC = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY} bg-[#0a0a23]`}>
    <div
      className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}
    >
      <div className=" flex flex-row items-center py-[6px] px-4 bg-gradient-to-r from-blue-700 to-blue-400 rounded-[10px] mb-2">
      ...
      <h1 className="w-full font-poppins font-semibold ss:text-[68px] text-[52px] text-blue-400 ss:leading-[100px] leading-[75px]">
        Payment Methond.
      </h1>
