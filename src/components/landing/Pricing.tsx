...
import { CheckIcon } from '@/icons/PricingCheckIcon';
import { RadioGroup, RadioGroupItem } from '@/components/pricing/radioGroup';
            ...
            >
                ...
                >
                    ...
                    <span
                        ...
                        typeof tier.discountPrice === 'object' && tier.discountPrice !== null && tier.discountPrice[frequency.value]
                            ? 'line-through'
                            : '',
                        )}
                    >
